...
import { ShoppingBag, Mail, KeyRound, User, Building2, ArrowLeft, CheckCircle } from "lucide-react";
          ...
          {step === "profile" && (
            <div className="bg-card border-4 border-black neo-shadow p-8">
              ...
              <form onSubmit={handleSetupProfile} className="space-y-5">
                ...
                <div>
                  <label className="text-xs font-black text-muted-foreground block mb-2">الصورة الشخصية (اختياري)</label>
